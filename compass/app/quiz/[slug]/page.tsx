...
function CheckIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <circle cx="10" cy="10" r="9" stroke="#3451B2" strokeWidth="1.5" />
      <path
    ...
    <div className="mx-auto flex min-h-[calc(100vh-3.5rem)] max-w-[560px] flex-col px-5 py-8">
      ...
      <div className="mt-auto pt-8">
        ...
        <Link
          ...
          className="block w-full rounded-xl bg-ink px-6 py-4 text-center text-base font-semibold text-white transition-colors hover:bg-black active:opacity-80"
        >
          검사 시작하기
        </Link>
      </div>
